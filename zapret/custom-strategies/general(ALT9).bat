...
--filter-tcp=443 --hostlist="/opt/zapret/hostlists/list-google.txt" --ip-id=zero --dpi-desync=hostfakesplit --dpi-desync-repeats=4 --dpi-desync-fooling=ts --dpi-desync-hostfakesplit-mod=host=www.google.com --new
--filter-tcp=80,443 --hostlist="/opt/zapret/hostlists/list-general.txt" --hostlist="/opt/zapret/hostlists/list-general-user.txt" --hostlist-exclude="/opt/zapret/hostlists/list-exclude.txt" --hostlist-exclude="/opt/zapret/hostlists/list-exclude-user.txt" --ipset-exclude="/opt/zapret/hostlists/ipset-exclude.txt" --ipset-exclude="/opt/zapret/hostlists/ipset-exclude-user.txt" --dpi-desync=hostfakesplit --dpi-desync-repeats=4 --dpi-desync-fooling=ts,md5sig --dpi-desync-hostfakesplit-mod=host=ozon.ru --dpi-desync-fake-http="/opt/zapret/files/fake/tls_clienthello_max_ru.bin" --new
